...
<script type="text/javascript">
  import AppGridBody from 'src/themes/phpzm/components/grid/components/Body.vue'

  import GeneralComputed from 'src/themes/phpzm/components/general/mixin-computed'
  import GeneralMethods from 'src/themes/phpzm/components/general/mixin-methods'

  import MixinComponents from 'src/themes/phpzm/components/grid/mixins/components'
  import MixinMethods from 'src/themes/phpzm/components/grid/mixins/methods'
  import MixinProps from 'src/themes/phpzm/components/grid/mixins/props'
  import MixinData from 'src/themes/phpzm/components/grid/mixins/data'
  import MixinHooks from 'src/themes/phpzm/components/grid/mixins/hooks'
  import MixinComputed from 'src/themes/phpzm/components/grid/mixins/computed'
  import MixinWatch from 'src/themes/phpzm/components/grid/mixins/watch'
