...
<script type="text/javascript">
  import CommonGridBody from 'src/app/modules/common/grid/components/Body.vue'
  ...
  import MixinComponents from 'src/app/modules/common/grid/mixins/components'
  import MixinMethods from 'src/app/modules/common/grid/mixins/methods'
  import MixinProps from 'src/app/modules/common/grid/mixins/props'
  import MixinData from 'src/app/modules/common/grid/mixins/data'
  import MixinHooks from 'src/app/modules/common/grid/mixins/hooks'
  import MixinComputed from 'src/app/modules/common/grid/mixins/computed'
  import MixinWatch from 'src/app/modules/common/grid/mixins/watch'
